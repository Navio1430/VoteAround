...
let passwordInput;
let checkboxInput;
let latitudeInput = document.getElementById('map-lat');
let longitudeInput = document.getElementById('map-long');
...
function showAlert() {
    ...
    let alertItems = [title, passwordInput, checkboxContainer, submitBtn];
...
export function validate() {
    if (passwordInput === undefined)
        return;
    if (-90 > latitudeInput.valueAsNumber ||
