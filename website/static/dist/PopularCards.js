const projectsContainerPopular = document.getElementById('projects-container-popular');
const index = 0;
const limit = 4;
async function getNext(index, limit) {
    let response = await fetch(`/api/projects/popular?index=${index}&limit=${limit}`);
